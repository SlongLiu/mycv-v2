...
<details class="short-bio">
  ...
  <div id="short-bio-text">
    ...
    <p>His research focuses on computer vision, self-evolving agents, and world models for embodied AI. He is the first author of Grounding DINO, one of the most widely used open-world object detection models. His research has received over 18,000 Google Scholar citations, and the open-source projects he has contributed to have collectively earned over 30,000 GitHub stars. Grounding DINO’s official models receive over two million downloads per month on Hugging Face. His honors include the WAIC Yunfan Award – Rising Star (2024), KAUST AI Rising Star (2024), and CCF-CV Academic Emerging Scholar Award (2023).</p>
  </div>
